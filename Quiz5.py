...
def show_question(question, possible_answers):
    for widget in frame.winfo_children():
        if widget != rfid_label:
            widget.destroy()
    question_label = tk.Label(frame, text=question, font=("Helvetica", 24), wraplength=700, justify="center")
    question_label.pack(pady=20)
    for idx, answer in enumerate(possible_answers):
        answer_button = tk.Button(frame, text=answer, font=("Helvetica", 18), wraplength=600, justify="center")
...
def show_correct_message(question_index):
    for widget in frame.winfo_children():
        if widget != rfid_label:
            widget.destroy()
    message_label = tk.Label(frame, text=correct_messages[question_index], font=("Helvetica", 24), wraplength=700, justify="center")
    message_label.pack(pady=20)
    message_label = tk.Label(frame, text=message_after_reply[question_index], font=("Helvetica", 24), wraplength=700,
                             justify="center")
    message_label.pack(pady=20)
...
def show_incorrect_message(question_index):
    for widget in frame.winfo_children():
        if widget != rfid_label:
            widget.destroy()
    message_label = tk.Label(frame, text=incorrect_messages[question_index], font=("Helvetica", 24), wraplength=700, justify="center")
    message_label.pack(pady=20)
    message_label = tk.Label(frame, text=message_after_reply[question_index], font=("Helvetica", 24), wraplength=700,
                             justify="center")
    message_label.pack(pady=20)
...
def start_quiz(language):
    ...
    if language == "pt":
        ...
        correct_messages = [
            "Correto! Boa resposta para a pergunta 1.",
            "Correto! Boa resposta para a pergunta 2.",
            "Correto! Boa resposta para a pergunta 3.",
            "Correto! Boa resposta para a pergunta 4.",
            "Correto! Boa resposta para a pergunta 5."
        ]
        ...
        correct_messages = [
            "Correct! Good answer to question 1.",
            "Correct! Good answer to question 2.",
            "Correct! Good answer to question 3.",
            "Correct! Good answer to question 4.",
            "Correct! Good answer to question 5."
        ]

        incorrect_messages = [
            "Incorrect! That wasn't the answer to question 1.",
            "Incorrect! That wasn't the answer to question 2.",
            "Incorrect! That wasn't the answer to question 3.",
            "Incorrect! That wasn't the answer to question 4.",
            "Incorrect! That wasn't the answer to question 5."
        ]
...
def show_language_selection():
    for widget in frame.winfo_children():
        widget.destroy()
    language_label = tk.Label(frame, text="Choose Language / Escolha a Língua", font=("Helvetica", 24), wraplength=700, justify="center")
...
def show_final_message():
    for widget in frame.winfo_children():
        if widget != rfid_label:
            widget.destroy()
    final_label = tk.Label(frame, text="Quiz Finished! / Quiz Finalizado!", font=("Helvetica", 24), wraplength=700, justify="center")
