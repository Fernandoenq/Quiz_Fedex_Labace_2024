...
def start_quiz(language):
    ...
    if language == "pt":
        ...
        answers = [
            ["CAIXA FEDEX 1: Transporte internacional", "CAIXA FEDEX 2: Transporte nacional", "CAIXA FEDEX 3: Serviços de logística", "CAIXA FEDEX 4: Todos os anteriores"],
            ["CAIXA FEDEX 1: 1 a 3 dias úteis", "CAIXA FEDEX 2: 1 a 5 dias úteis", "CAIXA FEDEX 3: 2 a 4 dias úteis", "CAIXA FEDEX 4: 2 a 5 dias úteis"],
            ["CAIXA FEDEX 1: Alto nível de segurança das cargas", "CAIXA FEDEX 2: Integração de sistemas para automação do processo",
             "CAIXA FEDEX 3: Rastreamento em tempo real", "CAIXA FEDEX 4: Todas as anteriores"],
            ["CAIXA FEDEX 1: Produtos de tabaco", "CAIXA FEDEX 2: Produtos perigosos ", "CAIXA FEDEX 3: Bilhetes de loteria", "CAIXA FEDEX 4: Correspondência"],
            ["CAIXA FEDEX 1: 30%", "CAIXA FEDEX 2: 50%", "CAIXA FEDEX 3: 100%", "CAIXA FEDEX 4: 70%"]
        ]
        correct_messages = [
            "Correto!",
            "Correto!",
        ...
        answers = [
            ["BOX FEDEX 1: International transportation", "BOX FEDEX 2: Domestic transportation", "BOX FEDEX 3: Logistics services",
             "BOX FEDEX 4: All of the above (correct)"],
            ["BOX FEDEX 1: 1 to 3 business days ", "BOX FEDEX 2: 1 to 5 business days", "BOX FEDEX 3: 2 to 4 business days", "BOX FEDEX 4: 2 to 5 business days"],
            ["BOX FEDEX 1: High-level cargo security", "BOX FEDEX 2: System integration for process automation", "BOX FEDEX 3: BOX FEDEX 1: Real-time tracking",
             "BOX FEDEX 4: All of the above "],
            ["BOX FEDEX 1: Tobacco products", "BOX FEDEX 2: Dangerous goods ", "BOX FEDEX 3: Lottery tickets", "BOX FEDEX 4: Correspondence"],
            ["BOX FEDEX 1: 30%", "BOX FEDEX 2: 50%", "BOX FEDEX 3: 100%", "BOX FEDEX 3: 70%"]
        ]
        correct_messages = [
            "Correct!",
            "Correct!",
...
def show_registration_form(language):
    ...
    x1, y1 = screen_width // 3 - 24 - 15, 1150 - 45  # Inicio do preto
    x2, y2 = screen_width // 2 + 205 + 15, 1150 + 45  # Final do preto
    create_rounded_rectangle(canvas, x1, y1, x2, y2, radius=20, outline='black', width=2, fill='black')
...
def show_language_selection():
    ...
    x1, y1 = screen_width // 6 - 20, screen_height // 4 + 40  # Inicio do preto
