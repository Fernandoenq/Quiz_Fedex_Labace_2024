...
def show_question(question, possible_answers):
    ...
    canvas.create_text(screen_width//2, screen_height // 4, text=question, font=("Helvetica", 24), width=900, fill="black")
    for idx, answer in enumerate(possible_answers):
        canvas.create_text(screen_width//2, screen_height // 4 + 300 + idx*40, text=answer, font=("Helvetica", 18), width=900, fill="black")
