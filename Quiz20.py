...
def show_question(question, possible_answers, current_question):
    ...
    #canvas.create_text(200, 152,text=f'Pergunta {current_question + 1}' if selected_language == "pt" else f'Question {current_question + 1}',font=("FedEx Sans", 18), width=900, fill="white")
    ...
    canvas.create_text(screen_width - 200, 152, text=f'Tempo: 20s', font=custom_font1,
    ...
    canvas.create_text(screen_width - (screen_width - 70), screen_height // 4, text=question, font=custom_font2, width=900,
                       fill="white", anchor="w")
    for idx, answer in enumerate(possible_answers):
        ...
        canvas.create_text(screen_width - (screen_width - 70), screen_height // 4 + 300 + idx * 150, text=answer, font=custom_font2,
...
def show_final_message():
    ...
    if current_hits > 3:
        ...
        last_message_pt = f"Retire o seu brinde"
    ...
    if selected_language == "pt":
        canvas.create_text(screen_width // 2, screen_height // 2 - 90, text=main_message_pt, font=custom_font1,
                           fill="white")
        canvas.create_text(screen_width // 2, screen_height // 2 - 20, text=sub_message_pt, font=custom_font2,
                           fill="white")
        canvas.create_text(screen_width // 2, screen_height // 2 + 60, text=last_message_pt, font=custom_font3,
                           fill="white")
    else:
        canvas.create_text(screen_width // 2, screen_height // 2 - 90, text=main_message_en, font=custom_font1,
                           fill="white")
        canvas.create_text(screen_width // 2, screen_height // 2 - 20, text=sub_message_en, font=custom_font2,
                           fill="white")
        canvas.create_text(screen_width // 2, screen_height // 2 + 60, text=last_message_en, font=custom_font3,
                           fill="white")
