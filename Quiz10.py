...
def show_registration_form(language):
    global selected_language, name_entry, email_entry, phone_entry, city_entry, company_entry, cnpj_entry
    selected_language = language
    canvas.delete("all")
    canvas.create_image(0, 0, image=background_photo, anchor="nw")

    canvas.create_text(screen_width//2, 100, text="Cadastro", font=("Helvetica", 24), width=900, fill="black")

    canvas.create_text(screen_width//2 - 200, 200, text="Nome:", font=("Helvetica", 18), width=200, fill="black", anchor="e")
    name_entry = tk.Entry(root, font=("Helvetica", 18))
    canvas.create_window(screen_width//2, 200, window=name_entry, anchor="w")

    canvas.create_text(screen_width//2 - 200, 250, text="Email:", font=("Helvetica", 18), width=200, fill="black", anchor="e")
    email_entry = tk.Entry(root, font=("Helvetica", 18))
    canvas.create_window(screen_width//2, 250, window=email_entry, anchor="w")

    canvas.create_text(screen_width//2 - 200, 300, text="Celular:", font=("Helvetica", 18), width=200, fill="black", anchor="e")
    phone_entry = tk.Entry(root, font=("Helvetica", 18))
    canvas.create_window(screen_width//2, 300, window=phone_entry, anchor="w")

    canvas.create_text(screen_width//2 - 200, 350, text="Cidade:", font=("Helvetica", 18), width=200, fill="black", anchor="e")
    city_entry = tk.Entry(root, font=("Helvetica", 18))
    canvas.create_window(screen_width//2, 350, window=city_entry, anchor="w")

    canvas.create_text(screen_width//2 - 200, 400, text="Empresa:", font=("Helvetica", 18), width=200, fill="black", anchor="e")
    company_entry = tk.Entry(root, font=("Helvetica", 18))
    canvas.create_window(screen_width//2, 400, window=company_entry, anchor="w")

    canvas.create_text(screen_width//2 - 200, 450, text="CNPJ:", font=("Helvetica", 18), width=200, fill="black", anchor="e")
    cnpj_entry = tk.Entry(root, font=("Helvetica", 18))
    canvas.create_window(screen_width//2, 450, window=cnpj_entry, anchor="w")

    register_button = tk.Button(root, text="Cadastrar", font=("Helvetica", 18), command=save_registration_data, fg="white", bg="black", width=20, height=2)
    canvas.create_window(screen_width//2, 500, window=register_button, anchor="center")
