...
def restart_quiz(event=None):
    ...
    current_question = 0
    current_hits = 0
    time_left = 20  # Reinicia o temporizador para 20 segundos
    rfid_data = ""
    is_paused = False
    stop_time_var = False
    rfid_allowed = False
...
def save_registration_data():
    ...
    data = {
        ...
        "CNPJ": "" if cnpj_entry.get() == "CNPJ inválido" else cnpj_entry.get(),  # Obtém o valor do campo de entrada "CNPJ"
