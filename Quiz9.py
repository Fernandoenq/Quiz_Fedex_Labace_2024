...
def start_quiz(language):
    ...
    if language == "pt":
        ...
        incorrect_messages = [
            ...
            "Incorreto! Não era essa a resposta da pergunta daa pergunta 3.",
...
def show_language_selection():
    ...
    canvas.create_image(screen_width//2, screen_height//2 - 100, image=logo_photo, anchor="center")
    pt_button = tk.Button(root, text="Português", font=("Helvetica", 18), command=lambda: start_quiz("pt"), fg="white", bg="black", width=40, height=4)
    pt_button_window = canvas.create_window(screen_width//2, screen_height//2, anchor="center", window=pt_button)
    en_button = tk.Button(root, text="English", font=("Helvetica", 18), command=lambda: start_quiz("en"), fg="white", bg="black", width=40, height=4)
